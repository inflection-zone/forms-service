...
import { ResourceReference } from '../../domain.types/file.resource.upload.domain.types';
...
export class FileResourceMapper {
    static toDetailsDto = (fileResource: FileResource): FileResourceDetailsDto => {
        ...
        const dto: FileResourceDetailsDto = {
            ...
            Versions: [],
            DefaultVersion: fileResource.DefaultVersion ? FileResourceMapper.toFileVersionDto(fileResource.DefaultVersion) : null,
        };
        return dto;
    };
    ...
    static toFileVersionDto = (fileVersion?: FileResourceVersion, sanitize = false): FileResourceMetadata => {
        ...
        var url =
            ConfigurationManager.BaseUrl() + '/api/v1/file-resources/' + fileVersion.ResourceId + '/download-by-version-name/' + fileVersion.Version;
